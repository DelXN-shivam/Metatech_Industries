...
export default function GrindingPolishingPage() {
    ...
    const products = [
        {
            name: "DPCM",
            image: "/productsListing/dpcm.png" // Update with real image path
        },
        {
            name: "Hi Speed DCM",
            image: "/productsListing/hi-speed-dcm.png" // Update with real image path
        },
        {
            name: "Ultra-Thin Diamond Cutter",
            image: "/productsListing/ultra-thin-diamond-cutter.png" // Update with real image path
        },
        {
            name: "Heavy-Duty Diamond Saw",
            image: "/productsListing/heavy-duty-diamond-saw.png" // Update with real image path
        }
    ];
