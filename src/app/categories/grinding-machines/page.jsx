...
export default function GrindingPolishingPage() {
    ...
    const products = [
        {
            name: "Metapol DC II",
            image: "/productsListing/metapol-dc-ii.png" // Placeholder, update with real path
        },
        {
            name: "Semi-Automatic Grinding Polishing",
            image: "/productsListing/semi-automatic-grinding.png"
        },
        {
            name: "Multi-Specimen Grinding Machine",
            image: "/productsListing/multi-specimen-grinder.png"
        },
        {
            name: "Heavy Duty Belt Grinder",
            image: "/productsListing/heavy-duty-belt-grinder.png"
        },
        {
            name: "Belt Grinder",
            image: "/productsListing/belt-grinder.png"
        },
        {
            name: "Planetary Grinding System",
            image: "/productsListing/planetary-grinding-system.png"
        },
        {
            name: "Dual-Head Grinder",
            image: "/productsListing/dual-head-grinder.png"
        }
    ];
