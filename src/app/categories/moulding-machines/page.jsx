...
export default function GrindingPolishingPage() {
    ...
    const products = [
        {
            name: "Moulding Machine - Automount E",
            image: "/productsListing/automount-e.png" // Placeholder, update with real path
        },
        {
            name: "Electro Hydraulic Press - Automount EH",
            image: "/productsListing/automount-eh.png"
        },
        {
            name: "Pneumatic Press - Automount",
            image: "/productsListing/automount-pneumatic.png"
        },
        {
            name: "Transparent Mould Making Machine",
            image: "/productsListing/transparent-mould-machine.png"
        },
        {
            name: "Dual-Station Mould Press",
            image: "/productsListing/dual-station-mould-press.png"
        }
    ];
