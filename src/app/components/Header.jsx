                ...
                <div className="flex justify-end items-center p-2">
                    <nav>
                        <ul className="flex flex-row items-center space-x-1 py-1">
                            <li>
                                <a href="#" className="hover:text-orange-500 text-2xl font-semibold hover:bg-slate-100 py-3 px-2">
                                    Home
                                </a>
                            </li>
                            ...
                            >
                                ...
                                {productsDropdown && (
                                    <ul className="absolute top-full left-0 mt-2 w-64 bg-white text-black border border-gray-200 z-50"
                                        ...
                                        onMouseLeave={() => handleMouseLeave('products')}
                                    >
                                        <li className="hover:bg-gray-200 p-2"><a href="#">Automatic Cutting Machine</a></li>
                                        <li className="hover:bg-gray-200 p-2"><a href="#">Diamond Cutting Machine</a></li>
                                        <li className="hover:bg-gray-200 p-2"><a href="#">Moulding Machines</a></li>
                                        <li className="hover:bg-gray-200 p-2"><a href="#">Grinding Machine</a></li>
                                        <li className="hover:bg-gray-200 p-2"><a href="#">Microscope and Image Analyser</a></li>
                                        <li className="hover:bg-gray-200 p-2"><a href="#">Image Analyser</a></li>
                                        <li className="hover:bg-gray-200 p-2"><a href="#">Particle Size Analysis System</a></li>
                                        <li className="hover:bg-gray-200 p-2"><a href="#">In-situ Metallography Kit</a></li>
                                        <li className="hover:bg-gray-200 p-2"><a href="#">Automatic Micro Hardness Tester</a></li>
                                    </ul>
                                )}
                            </li>
