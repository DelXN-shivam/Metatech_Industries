                ...
                {services.map((service, index) => (
                    ...
                    >
                        <div className="relative w-64 h-56 bg-white shadow-md rounded-lg transition-transform duration-300 group-hover:scale-105">
                            ...
                            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 rounded-full p-4 shadow-md transition-colors duration-300 group-hover:bg-purple-500">
                                <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-16 h-16 flex items-center justify-center rounded-full shadow-lg bg-orange-500 transition-colors duration-300 group-hover:bg-green-500">
                                    <img
                                        src={service.icon}
                                        alt="Service Icon"
                            ...
                            <div className="flex flex-col justify-evenly text-center h-full mt-8">
                                {/* Title Section */}
                                <h3 className="text-lg font-bold mb-4 text-gray-800 transition-colors duration-300 group-hover:text-purple-600">
                                    {service.title}
                                </h3>

                                {/* Description Section */}
                                <div className="p-4 rounded bg-gray-800 text-white transition-colors duration-300 group-hover:bg-purple-500 group-hover:text-gray-100">
