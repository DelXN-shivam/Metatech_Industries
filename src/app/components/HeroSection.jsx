...
const HeroSection = () => {
    ...
    return (
        <div>
            ...
            <motion.div
                className="absolute inset-x-0 -bottom-8 transform -translate-x-1/2 laptop:pt-20 flex flex-col phone:flex-row items-center justify-center space-y-4 phone:space-y-0 z-10"
                initial="hidden"
                animate="visible"
                variants={containerVarients}
            >
